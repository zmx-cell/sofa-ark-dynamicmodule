 ...
 */
public class TestClassLoader1Test {
    ...
    public void setUp() throws Exception {
        ...
        appClassLoader = TestClassLoader1Test.class.getClassLoader();

        ExplodedArchive explodedArchive = new ExplodedArchive(unpackFile);
        testClassloader = new TestClassloader(
                true, explodedArchive, new URL[] {unpackFile.toURL()}, null, appClassLoader, unpackFile);
    ...
    public void testTestClassLoader() throws ClassNotFoundException {
        ...
        Assert.assertEquals(jarLauncherClass.getClassLoader(), testClassloader);
    }
}