...
public class BizLauncher {
    ...
    private Object startBizAndInjectTestClasss(Class<?> testClass) {
        ...
        try {
            ...
            ((AbstractTestNGServerlessContextTests) testInstance).getSofaArkTestContextManager()
                .afterInstallBiz();
    ...
    private SofaArkTestContextManager getSofaArkTestContextManager(Class<?> testClass)
        ...
        if (sofaArkTestContextManager == null) {
            ...
            sofaArkTestContextManager = ((AbstractTestNGServerlessContextTests) testInstance)
                .getSofaArkTestContextManager();
            sofaArkTestContextManager.getSofaArkTestContext().updateState(testInstance, null,
                null);
        }
