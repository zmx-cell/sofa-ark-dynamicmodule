...
public class AbstractTestNGServerlessContextTests implements IHookable, ApplicationContextAware {
     ...
     */
    public AbstractTestNGServerlessContextTests() {
    ...
    private void reloadBuildTestContextManager() {
        if (ArkClient.getBizManagerService() != null) {
            ...
            if (biz != null) {
                ApplicationContext applicationContext = RootApplicationContextUtils.getApplicationContext(biz.getBizClassLoader());
                SofaArkTestContext serverlessTestContext = getSofaArkTestContextManager().getSofaArkTestContext();
                serverlessTestContext.setApplicationContext(applicationContext);
                this.testContextManager = serverlessTestContext.testContextManager(this.testContextManager.getTestContext());
            }
        }
    }
